...
- **[MaxTokensInterceptor](/zypher/core-concepts/loop-interceptors/built-in-interceptors#maxtokensinterceptor)** - Automatically continues conversations when responses are truncated
- **[ErrorDetectionInterceptor](/zypher/core-concepts/loop-interceptors/built-in-interceptors#errordetectioninterceptor)** - Detects and handles code errors using configurable detectors  
- **[ToolExecutionInterceptor](/zypher/core-concepts/loop-interceptors/built-in-interceptors#toolexecutioninterceptor)** - Handles tool execution with optional approval workflows
...
Loop interceptors provide powerful control over agent behavior. Next, explore [advanced deployment patterns](/zypher/guides/deployment) or learn about [creating custom tools](/zypher/guides/creating-custom-tools).
