...
description: Tools are what make Zypher Agents powerful - they're the hands and eyes that let your agent interact with the real world. The McpServerManager handles both built-in tools and external MCP servers seamlessly.
---
...
- **[File System Tools](/zypher/core-concepts/tools-and-mcp/built-in-tools#file-system-tools)** - Read, edit, search, and manage files
- **[Terminal Tools](/zypher/core-concepts/tools-and-mcp/built-in-tools#terminal-tools)** - Execute shell commands and scripts
- **[Search Tools](/zypher/core-concepts/tools-and-mcp/built-in-tools#search-tools)** - Find content across your codebase
- **[Image Tools](/zypher/core-concepts/tools-and-mcp/built-in-tools#image-tools)** - Process and analyze images (when configured)

For detailed documentation and examples, see the [Built-in Tools](/zypher/core-concepts/tools-and-mcp/built-in-tools) reference.
...
Tools are the foundation of your agent's capabilities. For comprehensive details on all available built-in tools, see the [Built-in Tools reference](/zypher/core-concepts/tools-and-mcp/built-in-tools). Next, learn about [Checkpoints](/zypher/core-concepts/checkpoints) to save and restore agent state.
