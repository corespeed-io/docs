...
- Complete the [Quick Start](/zypher/getting-started/quick-start) first
...
**Ready to build more?** Check out the [MCP Integration guide](/zypher/guides/mcp-integration) or explore [Advanced Workflows](/zypher/examples/advanced-workflows).
