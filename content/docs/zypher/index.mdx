...
### 🛠️ **Tool Integration**
Connect to any external service through the [Model Context Protocol (MCP)](/zypher/core-concepts/tools-and-mcp) - from web scraping to database queries.

### 🔄 **Loop Interceptors** 
Control execution flow with [interceptors](/zypher/core-concepts/loop-interceptors) for error handling, token management, and custom logic.

### 📝 **Git Checkpoints**
Track changes with [automatic checkpointing](/zypher/core-concepts/checkpoints) - revert to previous states when needed.
...
<Cards>
  <Card title="Quick Start" href="/zypher/quick-start" />
  <Card title="Core Concepts" href="/zypher/core-concepts" />
  <Card title="Examples" href="/zypher/examples" />
</Cards>
